...
One improvement over the \li{goto cleanup} pattern is that this can easily scale with more actions tied to multiple RAII objects, each such action then possibly being prevented a separate \xxx{dropped} instruction on some subset of control flow paths.
...
\section{A guideline for the compiler capable of modeling the proposed language model}
