...
\def\AbstractEN{%
Systems programming languages facilitate the implementation of software that runs in restricted environments close to the hardware, typically operating systems, drivers, and real-time and embedded systems.
