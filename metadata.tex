...
As the main result, the thesis provides a proof-of-concept in a prototype compiler of an extended version of C-{}- to LLVM, and describes a type system based on deferred constraint solving that is capable of type inference in presence of multi-parameter typeclasses and C-{}- subtypes.
