...
\newtheorem{remark}{Remark} %TODO odstranit
...
\def\cmmrepo{\footnote{The prototype compiler and its documentation are available on: \url{https://github.com/jiriklepl/masters-thesis-code}; more information given in \cref{chap:proto}}\xspace}
