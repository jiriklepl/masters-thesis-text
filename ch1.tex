...
\begin{itemize}
    \item  The solving of constraints can be performed in any arbitrary order as long as any possible algorithm extensions preserve its confluence property \cite{vytiniotis2011outsidein}.
