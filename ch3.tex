...
Flattening phase is much simpler and it just transcribes the function bodies and other nested control flow structures into flat forms. Flat forms are characterized by all \li{if} statements being transformed in the following manner:

\begin{ex}[Before and after flattening]
    \xxx{fix this issue}
