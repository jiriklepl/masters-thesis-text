...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \Else
            ...
            \State \Comment {for any reference, look up its corresponding operand in $vars$, otherwise in $r$, and if it is not present in either, consider it a global reference}
