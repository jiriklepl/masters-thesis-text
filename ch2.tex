...
\begin{itemize}
    ...
    \item Additional squared-bracket syntax for generic dereference \li{[address]} where \li{address} is typed \li{ptr (type)}, which is a generalization of the usual \cmm dereference syntax \li{type[address]}
